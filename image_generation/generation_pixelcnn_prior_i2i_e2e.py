...
def main(args):     
    ...
    for idx, topic in tqdm(enumerate(topics)):
        ...
        #imgs,_,_ = model.ae.decode(latent.view(args.batch_size, -1))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vqvae_model', type=str, default='models/tvqvae_cifar10_e2e_100/best_loss_prior.pt',
        help='filename containing the vqvae model')
    parser.add_argument('--samples', type=str, default='samples/cifar10_topic_e2e_i2i_100',
